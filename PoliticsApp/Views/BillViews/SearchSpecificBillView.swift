//
//  SearchSpecificBillView.swift
//  PoliticsApp
//
//  Created by Benjamin Rogers on 8/15/23.
//
...
struct SearchSpecificBillView_Previews: PreviewProvider {
    static var previews: some View {
        let specificBill = ProPublicaAPI().fetchAPIBillsSpecific(congressSession: 118, billSlug: "hr4004")!
